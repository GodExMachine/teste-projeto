...
<body>
	<div class="container">
		...
		<p>
			<b>Logradouro:</b>
			<%= endereco != null ? endereco.getLogradouro() : "-" %></p>
		<p>
			<b>Número:</b>
			<%= endereco != null ? endereco.getNumero() : "-" %></p>
		<p>
			<b>Complemento:</b>
			<%= endereco != null && endereco.getComplemento() != null ? endereco.getComplemento() : "-" %></p>
		<p>
			<b>Bairro:</b>
			<%= endereco != null ? endereco.getBairro() : "-" %></p>
		<p>
			<b>Cidade:</b>
			<%= endereco != null ? endereco.getCidade() : "-" %></p>
		<p>
			<b>Estado:</b>
			<%= endereco != null ? endereco.getEstado() : "-" %></p>
		<p>
			<b>CEP:</b>
			<%= endereco != null ? endereco.getCep() : "-" %></p>
